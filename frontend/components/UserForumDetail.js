// frontend/components/UserUserForumDetail.js
  ...
  return (
    <main className="container mx-auto px-6 md:px-12 py-24">
      ...
      <div className="text-center mb-12">
        <h4 className="text-3xl sm:text-4xl font-bold text-[#0C1E28] mt-0 sm:mt-0">
          Cireundeu
        </h4>
      ...
      <div className="bg-[#0C1E28] rounded-2xl p-6 mb-12">
        <div className="flex items-center">
          <div className="w-16 sm:w-24 h-20 bg-[#D6CF35] rounded-l-2xl"></div>
          <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-white ml-6">
            {forum.title}
          </h3>
        </div>
      </div>
          ...
          <div key={message.id} className="bg-white rounded-2xl p-6 shadow-md">
            ...
            <div className="flex justify-end space-x-4">
              <button
                ...
                className="text-[#0C1E28] font-bold text-lg sm:text-xl hover:underline"
              ...
              <button
                ...
                className="text-red-600 font-bold text-lg sm:text-xl hover:underline"
            ...
            {showReplyInput === message.id && (
              <div className="mt-4">
                <textarea
                  ...
                  className="w-full h-24 p-4 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#D6CF35] text-gray-800 text-base sm:text-lg md:text-xl"
                  placeholder="Tulis balasan Anda..."
                ></textarea>
                <div className="flex justify-end mt-2">
                  <button
                    onClick={() => handleReply(message.id)}
                    className="bg-[#DCCC3D] text-[#0C1E28] font-bold text-lg sm:text-xl px-6 py-2 rounded-full shadow-lg hover:bg-[#CBB736] transition duration-300"
                  >
                    Kirim Balasan
                  </button>
                </div>
      ...
      <div className="mt-12">
        ...
        <textarea
          ...
          className="w-full h-32 sm:h-40 p-4 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#D6CF35] text-gray-800 text-base sm:text-lg md:text-xl"
        ...
        <div className="flex justify-end mt-4">
          <button
            ...
            className="bg-[#DCCC3D] text-[#0C1E28] font-bold text-lg sm:text-xl px-8 py-3 rounded-full shadow-lg hover:bg-[#CBB736] transition duration-300"
          >
            Kirim
          </button>
        </div>
...
export default UserUserForumDetail;
