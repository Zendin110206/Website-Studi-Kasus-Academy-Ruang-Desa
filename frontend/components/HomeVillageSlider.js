// frontend/components/HomeHomeHomeVillageSlider.js
...
import "./HomeVillageSlider.css"; // Mengimpor custom CSS

const HomeVillageSlider = () => {
  // Pengaturan slider
  const settings = {
    dots: true,
...
export default HomeVillageSlider;
