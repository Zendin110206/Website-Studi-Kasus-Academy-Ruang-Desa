// frontend/components/MinisterMinisterProgramSection.js
"use client";
...
import {
  ...
  UserGroupIcon,
  EyeIcon,
} from "@heroicons/react/24/solid"; // Ensure these icons are installed
// Optionally, install React Icons for more icon options

const MinisterMinisterProgramSection = () => {
  const programs = [
    {
    ...
    {
      title: "Hiking",
      image: "/assets/minister/program hiking 1.png",
    },
    {
      title: "Vaksinasi",
      image: "/assets/minister/vaksinasi 2.png",
    },
    ...
    <section className="py-12" id="program">
      <div className="container mx-auto px-6 md:px-12 relative">
        ...
        <div className="absolute top-4 right-4">
          <Link
            href="/minister/program" // Mengarah ke halaman Program
...
export default MinisterMinisterProgramSection;
