  ...
  return (
    <div className="flex flex-col min-h-screen bg-white overflow-x-hidden">
      ...
      <main className="flex-grow container mx-auto px-4 sm:px-6 lg:px-12 py-6 sm:py-12 mt-8 sm:mt-16">
        ...
        {/* Form Tambah Forum */}
        <form onSubmit={handleSubmit} className="bg-[#F2F2F2] rounded-2xl p-4 sm:p-6 shadow-lg">
          {/* Title Input */}
          <div className="mb-6">
          ...
          {/* Description Input */}
          <div className="mb-6">
            <label htmlFor="description" className="block text-[#0C1E28] font-medium text-lg sm:text-xl mb-2">
              Deskripsi Forum
            </label>
            <textarea
              id="description"
