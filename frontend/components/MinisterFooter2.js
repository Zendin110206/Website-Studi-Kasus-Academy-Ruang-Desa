// frontend/components/MinisterMinisterFooter2.js
"use client";

import Link from "next/link";

const MinisterMinisterFooter2 = () => {
  return (
        ...
        <div className="flex flex-col items-center">
          ...
          <div className="flex flex-wrap justify-center space-x-4 sm:space-x-6 mb-6">
            <Link
              ...
              className="text-[#0C1E28] text-base sm:text-lg md:text-2xl font-bold"
            >
              Program
            </Link>
            <Link
...
export default MinisterMinisterFooter2;
