...
const EditAgendaPage = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-white overflow-x-hidden">
      ...
      {/* Content */}
      <main className="flex-grow container mx-auto px-4 sm:px-6 lg:px-12 py-6 sm:py-12 mt-16 sm:mt-24">
        {/* Judul */}
        ...
        {/* Form Edit Agenda */}
        {selectedAgenda && (
          <form onSubmit={handleSubmit} className="bg-[#DCCC3D] rounded-2xl p-6 sm:p-8 shadow-lg">
            {/* Judul Agenda */}
            <div className="mb-6">
              <label htmlFor="title" className="block text-[#0C1E28] font-medium text-lg sm:text-xl mb-2">
                Judul Agenda
              </label>
              <input
                id="title"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
              {/* Tanggal */}
              <div>
                <label htmlFor="date" className="block text-[#0C1E28] font-medium text-lg sm:text-xl mb-2">
                  Tanggal
                </label>
                <input
                  id="date"
              ...
              {/* Lokasi */}
              <div>
                <label htmlFor="location" className="block text-[#0C1E28] font-medium text-lg sm:text-xl mb-2">
                  Lokasi
                </label>
                <input
                  id="location"
              ...
              {/* Waktu */}
              <div>
                <label htmlFor="time" className="block text-[#0C1E28] font-medium text-lg sm:text-xl mb-2">
                  Waktu
                </label>
                <input
                  id="time"
              ...
              {/* CP */}
              <div>
                <label htmlFor="contact" className="block text-[#0C1E28] font-medium text-lg sm:text-xl mb-2">
                  CP
                </label>
                <input
                  id="contact"
