    ...
    <div className="relative bg-white w-full overflow-x-hidden min-h-screen">
      ...
      <main className="pt-24 relative">
        ...
        <section className="text-center mt-12">
          <h1 className="text-3xl sm:text-4xl font-bold text-[#0C1E28]">
            Bantuan
          </h1>
          <h2 className="text-6xl sm:text-8xl font-extrabold text-[#0C1E28] leading-tight">
            Sosial
          </h2>
        </section>
            ...
            <div className="bg-[#F2F2F2] rounded-2xl p-6 md:p-12 shadow-lg">
              ...
              <div className="relative mb-12">
                ...
                <div className="absolute inset-0 bg-[#0C1E28] rounded-2xl flex items-center">
                  {/* Yellow Accent */}
                  <div className="w-16 sm:w-24 h-full bg-[#D6CF35] rounded-l-2xl"></div>
                  {/* Title Text */}
              ...
              {/* Tujuan */}
              <div className="mb-12">
                <h2 className="text-2xl sm:text-3xl font-bold text-[#0C1E28] mb-4">
                  Tujuan
                </h2>
                <p className="text-base sm:text-lg md:text-xl text-[#0C1E28] whitespace-pre-line">
                  {detail.tujuan}
                </p>
              </div>
              ...
              <div className="flex justify-end items-center">
                <button
                  ...
                  className={`relative bg-[#DCCC3D] text-[#0C1E28] font-bold text-lg sm:text-xl px-6 sm:px-8 py-3 rounded-full shadow-lg hover:bg-[#CBB736] transition duration-300 flex items-center ${
                    isLoading || isSuccess
              ...
              {isSuccess && (
                <div className="mt-4 text-center">
                  <div className="flex items-center justify-center">
                    <CheckIcon className="w-6 h-6 text-green-500 mr-2" aria-hidden="true" />
                    <span className="text-green-500 font-semibold text-lg sm:text-xl">
                  ...
                  <button
                    ...
                    className="mt-4 bg-[#DCCC3D] text-[#0C1E28] font-bold text-lg sm:text-xl px-6 py-2 rounded-full shadow-lg hover:bg-[#CBB736] transition duration-300"
                  >
                    Kembali ke Beranda
                  </button>
                </div>
