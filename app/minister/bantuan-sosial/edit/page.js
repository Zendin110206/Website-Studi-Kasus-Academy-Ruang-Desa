...
const EditBantuanSosialPage = () => {
  ...
  const handleSelectChange = async (e) => {
    ...
    const bantuanData = {
      ...
      PKH: {
        nama: "PKH",
        deskripsi: "Program Keluarga Harapan (PKH) untuk keluarga kurang mampu.",
      },
      BPNT: {
        nama: "BPNT",
    ...
    <div className="flex flex-col min-h-screen bg-gray-50">
      ...
      <main className="flex-grow container mx-auto px-4 sm:px-6 lg:px-12 py-6 sm:py-1">
        ...
        <div className="text-center mb-8">
          <h4 className="mt-28 sm:mt-60 text-4xl sm:text-6xl font-bold text-gray-800">
            Edit
          </h4>
        ...
        <div className="bg-white rounded-2xl p-4 sm:p-8 shadow-lg">
          ...
          {selectedBansos && (
            isLoading ? (
              ...
              <form onSubmit={handleSubmit} className="bg-white rounded-2xl p-8 shadow-md mt-6">
                {/* Nama Bantuan Sosial */}
                <div className="mb-6">
                ...
                <div className="mb-6">
                  ...
                  <p className="text-sm text-gray-600 mt-1" id="deskripsiHelp">
                    Deskripsi harus mencakup informasi lengkap mengenai bantuan sosial.
                  </p>
                </div>
                ...
                <div className="flex justify-end mt-4">
                  ...
                  >
                    {isSubmitting ? (
                      <>
                        <FaSpinner className="animate-spin h-6 w-6 mr-2" aria-hidden="true" />
                        Menyimpan...
                      </>
                    ) : submitSuccess ? (
                      <>
                ...
                {submitSuccess && (
                  ...
                  >
                    <CheckIcon className="h-6 w-6 mr-2" aria-hidden="true" />
                    <span className="block sm:inline">Bantuan Sosial berhasil diubah.</span>
                  </div>
                )}
              </form>
            )
      ...
      >
        <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-lg w-full max-w-md">
          <h2 className="text-2xl font-semibold text-gray-800 mb-4">Konfirmasi Simpan</h2>
