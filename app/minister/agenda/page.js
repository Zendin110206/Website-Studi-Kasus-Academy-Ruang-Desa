    ...
    <div className="flex flex-col min-h-screen bg-white overflow-x-hidden">
      ...
      <main className="flex-grow container mx-auto px-4 sm:px-6 lg:px-12 py-6 sm:py-12 mt-24 sm:mt-32">
        ...
        <div className="text-center mb-8">
          <h4 className="mt-16 sm:mt-60 text-4xl sm:text-6xl font-bold text-[#0C1E28]">
            Cireundeu
          </h4>
            ...
            >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-4 text-[#0C1E28]">
                <div>
                  ...
                  <p className="font-bold text-base sm:text-lg">{agenda.date}</p>
                </div>
                <div>
                  <p className="font-medium text-base sm:text-lg">Lokasi</p>
                  <p className="font-bold text-base sm:text-lg">{agenda.location}</p>
                </div>
                <div>
                  <p className="font-medium text-base sm:text-lg">Waktu</p>
                  <p className="font-bold text-base sm:text-lg">{agenda.time}</p>
                </div>
                <div>
                  <p className="font-medium text-base sm:text-lg">CP</p>
                  <p className="font-bold text-base sm:text-lg">{agenda.contact}</p>
                </div>
              </div>
            </div>
          ))}
