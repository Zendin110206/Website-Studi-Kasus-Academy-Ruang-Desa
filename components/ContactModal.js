...
const ContactModal = ({ isOpen, closeModal }) => {
  ...
  const copyToClipboard = (text, field) => {
    navigator.clipboard.writeText(text).then(
      () => {
        setCopySuccess((prev) => ({ ...prev, [field]: `${field === "email" ? "Email" : "Phone"} copied!` }));
        setTimeout(() => {
              ...
              <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white dark:bg-gray-800 p-8 text-left align-middle shadow-xl transition-all">
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Tooltip id="copy-email-tooltip" place="top" variant="dark" />
                  </div>
                  {copySuccess.email && (
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Tooltip id="copy-phone-tooltip" place="top" variant="dark" />
                  </div>
                  {copySuccess.phone && (
                    <div className="text-green-500 text-xs">
                      {copySuccess.phone}
                ...
                <div className="mt-6 text-center text-sm text-gray-500 dark:text-gray-400">
                  Kami siap membantu Anda! Hubungi kami melalui salah satu cara di atas.
                </div>
              </Dialog.Panel>
            </Transition.Child>
          </div>
